...
func TestProcess_WithPassthroughProcessor_ModifiesMessage(t *testing.T) {
	...
	processorConfig := createTestProcessor("passthrough", "../../integration_tests/processors/passthrough.py")
...
func TestProcess_WithPayloadTransformer_ModifiesPayload(t *testing.T) {
	...
	processorConfig := createTestProcessor("payload_transformer", "../../integration_tests/processors/payload_transformer.py")
	chain, err := processor.NewChain([]*config.ProcessorConfig{processorConfig}, "test-server", "test-session")
	assert.NilError(t, err)
...
func TestProcess_WithSecurityValidator_RejectsDeleteRequests(t *testing.T) {
	...
	processorConfig := createTestProcessor("security_validator", "../../integration_tests/processors/security_validator.py")
	chain, err := processor.NewChain([]*config.ProcessorConfig{processorConfig}, "test-server", "test-session")
	assert.NilError(t, err)
...
func TestProcess_WithMultipleProcessors_ExecutesInOrder(t *testing.T) {
	...
	processor1 := createTestProcessor("passthrough", "../../integration_tests/processors/passthrough.py")
	processor2 := createTestProcessor("request_logger", "../../integration_tests/processors/request_logger.py")
